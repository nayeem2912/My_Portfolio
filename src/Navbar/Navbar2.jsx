...
const Navbar2 = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        tabIndex={0}
        className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-25 border border-orange-500 p-2 shadow">
  ...
  <div className="navbar-end">
    <a
                href="/resume.pdf"
                download
                className="inline-flex items-center gap-2 btn btn-xs sm:btn-sm md:btn-md  bg-orange-500 text-black rounded-md hover:bg-orange-600 transition"
              >
                <FaDownload />
                Resume
              </a>
